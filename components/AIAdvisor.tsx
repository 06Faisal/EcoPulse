...
const AIAdvisor: React.FC<AIAdvisorProps> = ({ insight, loading }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in zoom-in-95 duration-500 pt-4 pb-24">
      <div className="relative">
        ...
        <div className="relative glass p-8 rounded-[2.5rem] text-center border-slate-200 dark:border-white/10 bg-white/50 dark:bg-slate-900/50">
          <div className="w-20 h-20 bg-slate-900 dark:bg-emerald-500 rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-2xl">
          ...
          {isEliteEfficiency && !loading && (
            <div className="inline-block mt-4 px-4 py-1.5 bg-emerald-500 text-white text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed mt-4 px-4">
      ...
      {!loading && insight && (
        <>
            ...
            <div className="glass p-6 rounded-[2.5rem] bg-white dark:bg-slate-900/40">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
                  <div className="text-[9px] font-black text-slate-400 uppercase mb-1">Carbon Trend</div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
                  <div className="text-[9px] font-black text-slate-400 uppercase mb-1">Avg Daily Distance</div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl col-span-2">
                  <div className="text-[9px] font-black text-slate-400 uppercase mb-1">Peak Travel Days</div>
                  <div className="flex gap-2 mt-2 flex-wrap">
                    {insight.patterns.peakTravelDays.map(day => (
                      <span key={day} className="px-3 py-1 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[10px] font-black rounded-lg uppercase">
                        {day}
                      </span>
                    ))}
                  </div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl col-span-2">
                  <div className="text-[9px] font-black text-slate-400 uppercase mb-1">Most Used Vehicle</div>
                  <div className="flex items-center gap-2">
          ...
          <div className="glass p-6 rounded-[2.5rem] bg-white dark:bg-slate-900/40">
            <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">Regional Benchmarking</h3>
            ...
            <div className="grid grid-cols-2 gap-3 mt-6">
              <div className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                ...
                <span className="text-[10px] font-black text-slate-600 dark:text-slate-400">Your Current Trend</span>
              </div>
              <div className="flex items-center gap-2 p-3 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl">
                <div className="w-3 h-3 rounded bg-emerald-500"></div>
                <span className="text-[10px] font-black text-emerald-600 dark:text-emerald-400">Optimized Target</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between px-1">
               <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Personal Protocols</h3>
               <span className={`text-[9px] font-black px-2 py-1 rounded-lg ${isEliteEfficiency ? 'bg-emerald-500 text-white' : 'bg-emerald-500/10 text-emerald-500'}`}>
            ...
            {(insight.recommendations ?? []).map((rec, i) => (
              <div key={i} className="glass p-5 rounded-[2rem] flex items-start gap-5 border-slate-200 dark:border-white/5 hover:bg-white dark:hover:bg-slate-800 transition-all duration-300 group">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-medium">{rec}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-24">
          ...
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest animate-pulse"> Analyzing...</p>
        </div>
      )}
    </div>
  );
