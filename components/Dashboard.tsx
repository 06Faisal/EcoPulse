...
const Dashboard: React.FC<DashboardProps> = ({ trips, electricity, insight, user, loading }) => {
  ...
  return (
    <div className="space-y-8 pt-4 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-4">
      <div className="glass p-6 rounded-[2rem] border-slate-200 dark:border-white/10 space-y-5">
        <div className="flex justify-between items-end">
          <div>
            ...
            <div className="flex items-baseline gap-1 mt-1">
              ...
              <span className="text-slate-500 dark:text-slate-400 font-bold text-sm italic">kg CO2e</span>
            </div>
          </div>
